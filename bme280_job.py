...
try:
    sqliteConnection = sqlite3.connect('environment_readings.db')
    ...
    count = cursor.execute("INSERT INTO sensor_readings (ctemp, ftemp, pressure, humidity, created_date) VALUES (%s, %s, %s, %s, %s)" % (str(cTemp), str(fTemp), str(pressure), str(humidity), time.time()))
