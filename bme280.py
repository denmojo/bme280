# Distributed with a free-will license.<br># Use it any way you want, profit or free, provided it fits in the licenses of its associated works.
# BME280
...
inpressure = pressure * 0.029529983071445
...
print("Temperature in Fahrenheit : %.1f° F" %fTemp)
print("Pressure                  : %.2f hPa (mbar) " %pressure)
print("Pressure inches Hg        : %.2f in" %inpressure)
